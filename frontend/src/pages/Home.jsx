...
export default function Home(){
  return (
    <section className="text-center py-12">
      <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-offWhite">ReZoomed — AI Resume & Job Matcher</h1>
      <p className="mt-4 text-offWhite/70 max-w-2xl mx-auto">Upload your resume and paste a job description to see how well they match.</p>
